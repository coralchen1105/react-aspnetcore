  ...
  swapStatus = () => {
    switch (this.props.sessionRec.interestLevel) {
      case STATUS_ATTENDING:
        this.props.onUpdate({
          ...this.props.sessionRec,
          ...{ interestLevel: STATUS_DEFAULT }
        });
        break;
      ...
      case STATUS_INTERESTED:
        this.props.onUpdate({
          ...this.props.sessionRec,
          ...{ interestLevel: STATUS_ATTENDING }
        });
        break;
      ...
      case STATUS_DEFAULT:
        this.props.onUpdate({
          ...this.props.sessionRec,
          ...{ interestLevel: STATUS_INTERESTED }
        });
        break;

      default:
        console.log(
          "SessionButton:swapStatus:NoChange:interestLevel:" +
            this.props.interestLevel
        );
    }
  };
                  ...
                  <i>
                    <b>
                      {this.getCurrentStatusText(
                        this.props.sessionRec.interestLevel,
